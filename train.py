...
if __name__ == "__main__":
    ...
    valid_dataset = Dataset(run.cfg.dataset_path, run.cfg.model.grid_dim, train=False, max_samples=run.cfg.max_samples, file_list=pth.join(run.dir, "valid_files.csv"))
